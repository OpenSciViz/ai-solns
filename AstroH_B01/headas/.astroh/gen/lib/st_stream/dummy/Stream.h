...
// macros to set method name and write prefix
#define AH_DEBUG formatter1().setMethod(__FUNCTION__); formatter1().debug() << st_stream::prefix
#define AH_OUT formatter1().setMethod(__FUNCTION__); formatter1().out() << st_stream::prefix
#define AH_INFO formatter1().setMethod(__FUNCTION__); formatter1().info() << st_stream::prefix
#define AH_INFO1 formatter1().setMethod(__FUNCTION__); formatter1().info(1) << st_stream::prefix
#define AH_INFO2 formatter1().setMethod(__FUNCTION__); formatter1().info(2) << st_stream::prefix
#define AH_INFO3 formatter1().setMethod(__FUNCTION__); formatter1().info(3) << st_stream::prefix
#define AH_INFO4 formatter1().setMethod(__FUNCTION__); formatter1().info(4) << st_stream::prefix
#define AH_WARN formatter1().setMethod(__FUNCTION__); formatter1().warn() << st_stream::prefix
#define AH_WARN1 formatter1().setMethod(__FUNCTION__); formatter1().warn(1) << st_stream::prefix
#define AH_WARN2 formatter1().setMethod(__FUNCTION__); formatter1().warn(2) << st_stream::prefix
#define AH_WARN3 formatter1().setMethod(__FUNCTION__); formatter1().warn(3) << st_stream::prefix
#define AH_WARN4 formatter1().setMethod(__FUNCTION__); formatter1().warn(4) << st_stream::prefix
#define AH_ERR formatter1().setMethod(__FUNCTION__); formatter1().err() << st_stream::prefix
