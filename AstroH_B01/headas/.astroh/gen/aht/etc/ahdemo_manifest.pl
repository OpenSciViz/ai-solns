...
#  default => "",
  default => "ahdemo",
  valvec => ["ahcxxdemo", "./bin/status", "./bin/fitsverify", "./bin/suzakuversion", "./bin/hxdpi", "./bin/xispi", "./bin/xiscoord", "./bin/xissim"]
},
#
...
#  valvec => ["./input/event_file_3.fits[events]", "./input/event_file_2.fits[events]", "./input/event_file_1.fits[events]", "./input/astroh-short.fits", "./input/astroh-long.fits"]  
  valvec => ["event_file_1.fits", "event_file_2.fits", "event_file_3.fits", "event_file_list.txt", "ref.tbz2"] 
},    
#    
