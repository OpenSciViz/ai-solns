#if !defined(LUTSGD_C)
#define LUTSGD_C const char lutSGD_rcsId_svnId[] = "$Id: lutSGD.cxx,v 1.2 2012/07/20 20:58:50 dhon Exp $"; 
...
namespace {
  const string cvsId = "$Name: AstroH_B01 $ $Id: lutSGD.cxx,v 1.2 2012/07/20 20:58:50 dhon Exp $";
...
namespace ahsgd {
  ...
  int asicCountOffset() { return SGD_Occurance_HeaderSizeInBytes - 2; }
  ...
  int firstEventOffset() { return SGD_Occurance_HeaderSizeInBytes; } 

  int firstActvChanFlagOffset() { return SGD_Occurance_HeaderSizeInBytes + 2; } 
  ...
  // SGD as an "occurance" vector-list Bit64 items. (SGD func must provide Bit64 items)
